(function (factory) {
  ...
  Chart.defaults.global.multiTooltipTemplate = "<%if (datasetLabel){%><%=datasetLabel%>: <%}%><%= value + 'kWh' %>";
  ...
  function ChartJsFactory (ChartJs, $timeout) {
    ...
    function getChartColorFn (scope) {
      return typeof scope.chartGetColor === 'function' ? scope.chartGetColor : getDefaultColor;
    }
